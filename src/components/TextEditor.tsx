      ...
      <AnimatePresence>
        {blocks.map((block, index) => (
          ...
          >
            ...
            <motion.div
              animate={{
                x: hoveredBlock === block.id ? -20 : 0,
                scale: hoveredBlock === block.id ? 0.98 : 1
              }}
              transition={{ type: "spring", stiffness: 300, damping: 30 }}
              className="bg-white box-border content-start flex flex-wrap gap-6 items-start justify-start min-w-60 p-6 rounded-lg w-full border border-gray-200 shadow-sm hover:shadow-md transition-shadow"
            >
              {/* Drag handle */}
